 ...
 */
const liveStateMaps: Set<WeakRef<Clearable>> = new Set<WeakRef<Clearable>>();
const finalizationRegistry: FinalizationRegistry<WeakRef<Clearable>> = new FinalizationRegistry<WeakRef<Clearable>>(
    (ref: WeakRef<Clearable>): void => {
...
export class StateMap<K, V> extends State implements Map<K, V> {
    ...
    public constructor() {
        super();
        const ref: WeakRef<Clearable> = new WeakRef<Clearable>(this);
    ...
    public static clearAll(): void {
        for (const ref of liveStateMaps) {
            const stateMap: Clearable | undefined = ref.deref();
